    ...
    $(function(){
      ...
      $("#btExecUpdate").click(checkUsersData);;
      $("#btExecUpdate").mousedown(checkButtonCheck);
      $("#btExecDelete").click(alertMessageDeleteUser);
      $("#btExecDelete").mousedown(checkButtonCheck);
    });
    ...
    function alertMessageStartRegister(){
      ...
      $('#dialog').dialog(
      {
        ...
        open: function(){
          $('#dialog').html(
            '<table border="1">' +
            '<tr><td>ユーザ番号</td><td>' + userId + '</td></tr>' + 
            '<tr><td>ユーザ名</td><td>' + surName + ' ' + firstName + '</td></tr>' + 
    ...
    /*message button before deleting user*/
    function alertMessageDeleteUser(){
      var col = getUsersData();
      var userId = col["userId"];
      var surName = col["surName"];
      var firstName = col["firstName"]; 
